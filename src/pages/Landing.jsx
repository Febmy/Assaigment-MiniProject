      ...
      <div className="relative z-10 min-h-[calc(100dvh-56px)] grid place-items-center px-4">
        <div className="w-full max-w-2xl rounded-2xl bg-white/20 backdrop-blur-xl shadow-2xl p-8 md:p-12 border border-white/30">
          ...
          <div className="mt-8 flex items-center gap-4">
            <Link
              to="/login"
              className="px-6 py-2.5 rounded-full text-white font-medium shadow-lg bg-gradient-to-r from-blue-500 to-indigo-500 hover:opacity-95 transition"
            >
              Login
            </Link>
            <Link
              to="/register"
              className="px-6 py-2.5 rounded-full font-medium text-white shadow-lg border border-white/70 hover:bg-white/10 transition"
            >
              Register
            </Link>
            <Link
